...
export default function EditProductPage() {
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold text-gray-800 dark:text-white mb-6">Edit Product</h1>
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6 max-w-lg space-y-4">
        ...
        <div>
          ...
          <InputField id="unit" name="unit" value={form.unit} onChange={handleChange} />
        </div>
        <div>
