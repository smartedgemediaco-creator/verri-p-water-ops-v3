...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const email = await sendEmail({
      to: notifyEmail,
      subject: `Daily Database Backup — ${summary.filename} (${summary.recordCount} records)`,
      html: `<p>This is the automated daily backup of the Verri P database.</p>
...
<p>The full JSON backup is attached. Keep this email safe — it is the recovery copy for the usage/stock deletion safety net.</p>`,
