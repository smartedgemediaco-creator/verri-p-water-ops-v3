...
const navItems: NavItem[] = [
  ...
  { icon: <ListIcon />, name: "Daily Staff Pay", path: "/daily-production", color: "text-amber-500" },
  { icon: <GroupIcon />, name: "Commissioned Staffs", path: "/commissioned-staffs", color: "text-orange-500" },
  ...
  { icon: <DollarLineIcon />, name: "Sales (Factories)", path: "/sales?type=factory", color: "text-blue-500" },
  { icon: <DollarLineIcon />, name: "Sales (Depots)", path: "/sales?type=depot", color: "text-emerald-500" },
